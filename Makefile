#############################################################################
# Makefile for building: gem_view_srs
...
CXXFLAGS      = -std=c++11 -O2 -std=gnu++11 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
...
DISTDIR = /home/daq/test/SRS_Viewer/SRS_GEM_View/obj/gem_view_srs1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -L${CODA}/Linux-x86_64/lib -levio -let -L${ROOTSYS}/lib -lCore -lRIO -lNet -lHist -lGraf -lGraf3d -lGpad -lTree -lRint -lPostscript -lMatrix -lPhysics -lGui -lRGL /usr/lib64/libQt5Widgets.so /usr/lib64/libQt5Gui.so /usr/lib64/libQt5Core.so /usr/lib64/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/EvioFileReader.cpp \
		...
		src/GEMPedestal.cpp \
		src/ETViewer.cpp \
		src/ETChannel.cpp moc/moc_Viewer.cpp \
		moc/moc_HistoWidget.cpp \
		moc/moc_ETViewer.cpp
...
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		include/ETViewer.h \
		include/ETChannel.h src/EvioFileReader.cpp \
		src/EventParser.cpp \
		src/MPDVMERawEventDecoder.cpp \
		src/MPDSSPRawEventDecoder.cpp \
		src/AbstractRawDecoder.cpp \
...
moc/moc_predefs.h: /usr/lib64/qt5/mkspecs/features/data/dummy.cpp
	g++ -std=c++11 -O2 -std=gnu++11 -Wall -W -dM -E -o moc/moc_predefs.h /usr/lib64/qt5/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc/moc_Viewer.cpp moc/moc_HistoWidget.cpp moc/moc_ETViewer.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_Viewer.cpp moc/moc_HistoWidget.cpp moc/moc_ETViewer.cpp
moc/moc_Viewer.cpp: include/Viewer.h \
	...
	/usr/lib64/qt5/bin/moc $(DEFINES) --include /home/daq/test/SRS_Viewer/SRS_GEM_View/moc/moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/daq/test/SRS_Viewer/SRS_GEM_View -I/home/daq/test/SRS_Viewer/SRS_GEM_View -I/home/daq/test/SRS_Viewer/SRS_GEM_View/include -I'/home/daq/test/SRS_Viewer/SRS_GEM_View/${CODA}/common/include' -I'/home/daq/test/SRS_Viewer/SRS_GEM_View/${ROOTSYS}/include' -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/4.8.5 -I/usr/include/c++/4.8.5/x86_64-redhat-linux -I/usr/include/c++/4.8.5/backward -I/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include -I/usr/local/include -I/usr/include include/Viewer.h -o moc/moc_Viewer.cpp
...
obj/ETViewer.o: src/ETViewer.cpp include/ETViewer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/ETViewer.o src/ETViewer.cpp

obj/ETChannel.o: src/ETChannel.cpp include/ETChannel.h \
		include/ETViewer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/ETChannel.o src/ETChannel.cpp
...
obj/moc_ETViewer.o: moc/moc_ETViewer.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/moc_ETViewer.o moc/moc_ETViewer.cpp
